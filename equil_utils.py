...
#    def getSHORTid(self):
    ...
    def __w7xconfigs__(self):
        ...
        config = {'A': _ut.Struct(), 'B': _ut.Struct(),
                  'C': _ut.Struct(), 'D': _ut.Struct(),
                  'E': _ut.Struct(), 'F': _ut.Struct(),
                  'G': _ut.Struct(), 'H': _ut.Struct(),
                  'I': _ut.Struct(), 'J': _ut.Struct()}
