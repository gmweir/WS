...
def create_local_configs(vmec_local='C:\PortablePrograms\configs\\'):
    ...
    label        = {0: 'EIM000'}
    stream    = {0: '1000_1000_1000_1000_+0000_+0000/01/00/boozer.txt'}
    label[1]     ='EIM065'
    stream[1] = '1000_1000_1000_1000_+0000_+0000/01/04m/boozer.txt'
    label[2]     = 'KJM000'
    stream[2] = '1020_1080_0930_0843_+0000_+0000/01/00/boozer.txt'
    label[3]     = 'FTM000'
    stream[3] = '1000_1000_1000_1000_-0690_-0690/01/00/boozer.txt'
    ...
    ''' returns link to VMEC url 
        ...
        availabel labels:
            ...
            KJM000
                    ...
                    '''
    co={'EIM000': '/w7x/1000_1000_1000_1000_+0000_+0000/01/00/',
